...
void setup() 
{
  ...
  centro[0] = xmm; // x del punto 0
  centro[1] = ymm; // y del punto 0
  centro[2] = zmm; // z del punto 0
...
void loop() 
{
  ...
  */
  ...
  x2mm = centro[0] + RAGGIO_MM * sin((millis() * 6.28) / DELTA_T_MS);
  y2mm = centro[1] - RAGGIO_MM * cos((millis() * 6.28) / DELTA_T_MS);
  z2mm = centro[2];
