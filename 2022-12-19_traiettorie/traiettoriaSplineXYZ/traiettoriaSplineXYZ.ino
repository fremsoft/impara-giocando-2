/* 
 *  Spline Cubica Hermite naturale
 *  VEDI LA LEZIONE COMPLETA :  https://youtu.be/MPPVonD1w5E
 *  
...
void setup() 
{
  ...
  t0 = millis();
  calcolaCoefficientiSpline( punto0[0], punto1[0], 
                             &coefX[0], &coefX[1], &coefX[2], &coefX[3] );
  calcolaCoefficientiSpline( punto0[1], punto1[1], 
                             &coefY[0], &coefY[1], &coefY[2], &coefY[3] );
  calcolaCoefficientiSpline( punto0[2], punto1[2], 
  ...
  switch (stato_movimento) {
    case 1:
      ...
      if ( (millis() - t0) >= DELTA_T_MS ) {
        t0 = millis();
        calcolaCoefficientiSpline( punto1[0], punto2[0], 
             &coefX[0], &coefX[1], &coefX[2], &coefX[3] );
        calcolaCoefficientiSpline( punto1[1], punto2[1], 
             &coefY[0], &coefY[1], &coefY[2], &coefY[3] );
        calcolaCoefficientiSpline( punto1[2], punto2[2], 
             &coefZ[0], &coefZ[1], &coefZ[2], &coefZ[3] );
        stato_movimento = 2;
      }
      break;
    ...
    case 2:
      ...
      if ( (millis() - t0) >= DELTA_T_MS ) {
        t0 = millis();
        calcolaCoefficientiSpline( punto2[0], punto3[0], 
             &coefX[0], &coefX[1], &coefX[2], &coefX[3] );
        calcolaCoefficientiSpline( punto2[1], punto3[1], 
             &coefY[0], &coefY[1], &coefY[2], &coefY[3] );
        calcolaCoefficientiSpline( punto2[2], punto3[2], 
             &coefZ[0], &coefZ[1], &coefZ[2], &coefZ[3] );
        stato_movimento = 3;
      }
      break;
    ...
    case 3:
      ...
      if ( (millis() - t0) >= DELTA_T_MS ) {
        t0 = millis();
        calcolaCoefficientiSpline( punto3[0], punto0[0], 
             &coefX[0], &coefX[1], &coefX[2], &coefX[3] );
        calcolaCoefficientiSpline( punto3[1], punto0[1], 
             &coefY[0], &coefY[1], &coefY[2], &coefY[3] );
        calcolaCoefficientiSpline( punto3[2], punto0[2], 
             &coefZ[0], &coefZ[1], &coefZ[2], &coefZ[3] );
        stato_movimento = 4;
      }
      break;
