...
volatile float t0_ovl;
volatile float t0_gross;       // TMR0 + t0_ovl
volatile float t0_gross_prec;  // TMR0 + t0_ovl precedente
volatile float frequenza;
...
void loop() {
    ...
    // f contiene la frequenza asintotica espressa in Hz, 
