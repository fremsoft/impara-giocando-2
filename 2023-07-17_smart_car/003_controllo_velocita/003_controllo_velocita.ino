 ...
 *  Questo programma li gestisce a polling, la porta seriale 
 *  potrebbe falsare la misura, pertanto bisogna che sia impostato 
 *  il massimo baud rate possibile (115200).
 *  
...
void loop() {
   ...
   Serial.print(velocitaRPM[0]);
   Serial.print(",");
   Serial.print(velocitaRPM[1]);
   Serial.print(",");
   Serial.print(velocitaRPM[2]);
   Serial.print(",");
   Serial.println(velocitaRPM[3]);
