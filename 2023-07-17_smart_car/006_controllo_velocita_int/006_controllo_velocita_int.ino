/*
    ...
    https://youtube.com/live/so93c_Gyh-Y
...
void setup() {
  ...
  */
  ...
  setPointVelocitaRPM[0] = 50;  /* espresso in RPM */
  setPointVelocitaRPM[1] = 50;  /* espresso in RPM */
  setPointVelocitaRPM[2] = 50;  /* espresso in RPM */
  setPointVelocitaRPM[3] = 50;  /* espresso in RPM */
