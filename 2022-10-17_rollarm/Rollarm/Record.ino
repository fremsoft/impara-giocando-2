...
void Mapping1()
{
  Joint0[Time] = map(Joint0[Time], 0, 1024, 10, 170); 
  Joint1[Time] = map(Joint1[Time], 0, 1024, 10, 170); 
  Joint2[Time] = map(Joint2[Time], 0, 1024, 10, 170); 
  Joint3[Time] = map(Joint3[Time], 0, 1024, 100, 180); 
  Time++;
}
